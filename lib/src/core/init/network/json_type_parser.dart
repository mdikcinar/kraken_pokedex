import 'package:kraken_pokedex/src/core/helpers/exceptions.dart';
...
class JsonTypeParser {
  static const Map<Type, JsonFactory<dynamic>> factories = {
    PaginatedData<Pokemon>: PaginatedData<Pokemon>.fromJson,
    Pokemon: Pokemon.fromJson,
    PokemonDetail: PokemonDetail.fromJson,
  };
